...
export interface TablerBrandAmongUsIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandAmongUsIcon = React.forwardRef<SVGSVGElement, TablerBrandAmongUsIconProps>(
	function TablerBrandAmongUsIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandAmongUsIcon.displayName = "TablerBrandAmongUsIcon";
}
