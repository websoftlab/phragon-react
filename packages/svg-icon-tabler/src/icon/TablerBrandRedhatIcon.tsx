...
export interface TablerBrandRedhatIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandRedhatIcon = React.forwardRef<SVGSVGElement, TablerBrandRedhatIconProps>(
	function TablerBrandRedhatIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandRedhatIcon.displayName = "TablerBrandRedhatIcon";
}
