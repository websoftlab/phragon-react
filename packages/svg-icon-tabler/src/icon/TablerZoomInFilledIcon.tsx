...
export interface TablerZoomInFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerZoomInFilledIcon = React.forwardRef<SVGSVGElement, TablerZoomInFilledIconProps>(
	function TablerZoomInFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerZoomInFilledIcon.displayName = "TablerZoomInFilledIcon";
}
