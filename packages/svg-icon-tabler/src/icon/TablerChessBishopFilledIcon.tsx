...
export interface TablerChessBishopFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerChessBishopFilledIcon = React.forwardRef<SVGSVGElement, TablerChessBishopFilledIconProps>(
	function TablerChessBishopFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerChessBishopFilledIcon.displayName = "TablerChessBishopFilledIcon";
}
