...
export interface TablerPawOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerPawOffIcon = React.forwardRef<SVGSVGElement, TablerPawOffIconProps>(function TablerPawOffIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerPawOffIcon.displayName = "TablerPawOffIcon";
}
