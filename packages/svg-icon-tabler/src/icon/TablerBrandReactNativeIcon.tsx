...
export interface TablerBrandReactNativeIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandReactNativeIcon = React.forwardRef<SVGSVGElement, TablerBrandReactNativeIconProps>(
	function TablerBrandReactNativeIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandReactNativeIcon.displayName = "TablerBrandReactNativeIcon";
}
