...
export interface TablerSquareRoundedArrowLeftFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSquareRoundedArrowLeftFilledIcon = React.forwardRef<
	SVGSVGElement,
	TablerSquareRoundedArrowLeftFilledIconProps
>(function TablerSquareRoundedArrowLeftFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerSquareRoundedArrowLeftFilledIcon.displayName = "TablerSquareRoundedArrowLeftFilledIcon";
}
