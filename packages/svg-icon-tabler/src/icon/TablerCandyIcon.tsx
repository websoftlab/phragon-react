...
export interface TablerCandyIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerCandyIcon = React.forwardRef<SVGSVGElement, TablerCandyIconProps>(function TablerCandyIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerCandyIcon.displayName = "TablerCandyIcon";
}
