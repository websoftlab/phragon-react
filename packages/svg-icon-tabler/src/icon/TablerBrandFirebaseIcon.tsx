...
export interface TablerBrandFirebaseIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandFirebaseIcon = React.forwardRef<SVGSVGElement, TablerBrandFirebaseIconProps>(
	function TablerBrandFirebaseIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandFirebaseIcon.displayName = "TablerBrandFirebaseIcon";
}
