...
export interface TablerReplaceFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerReplaceFilledIcon = React.forwardRef<SVGSVGElement, TablerReplaceFilledIconProps>(
	function TablerReplaceFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerReplaceFilledIcon.displayName = "TablerReplaceFilledIcon";
}
