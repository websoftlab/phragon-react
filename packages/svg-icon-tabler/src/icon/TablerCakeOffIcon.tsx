...
export interface TablerCakeOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerCakeOffIcon = React.forwardRef<SVGSVGElement, TablerCakeOffIconProps>(function TablerCakeOffIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerCakeOffIcon.displayName = "TablerCakeOffIcon";
}
