...
export interface TablerAlarmMinusFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerAlarmMinusFilledIcon = React.forwardRef<SVGSVGElement, TablerAlarmMinusFilledIconProps>(
	function TablerAlarmMinusFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerAlarmMinusFilledIcon.displayName = "TablerAlarmMinusFilledIcon";
}
