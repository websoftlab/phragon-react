...
export interface TablerBathFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBathFilledIcon = React.forwardRef<SVGSVGElement, TablerBathFilledIconProps>(
	function TablerBathFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerBathFilledIcon.displayName = "TablerBathFilledIcon";
}
