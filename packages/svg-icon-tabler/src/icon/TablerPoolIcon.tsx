...
export interface TablerPoolIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerPoolIcon = React.forwardRef<SVGSVGElement, TablerPoolIconProps>(function TablerPoolIcon(props, ref) {
...
if (__isDev__()) {
	TablerPoolIcon.displayName = "TablerPoolIcon";
}
