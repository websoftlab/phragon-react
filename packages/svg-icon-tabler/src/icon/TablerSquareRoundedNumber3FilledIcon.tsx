...
export interface TablerSquareRoundedNumber3FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSquareRoundedNumber3FilledIcon = React.forwardRef<
	SVGSVGElement,
	TablerSquareRoundedNumber3FilledIconProps
>(function TablerSquareRoundedNumber3FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerSquareRoundedNumber3FilledIcon.displayName = "TablerSquareRoundedNumber3FilledIcon";
}
