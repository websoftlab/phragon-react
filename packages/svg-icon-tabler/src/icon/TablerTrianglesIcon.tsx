...
export interface TablerTrianglesIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerTrianglesIcon = React.forwardRef<SVGSVGElement, TablerTrianglesIconProps>(
	function TablerTrianglesIcon(props, ref) {
...
if (__isDev__()) {
	TablerTrianglesIcon.displayName = "TablerTrianglesIcon";
}
