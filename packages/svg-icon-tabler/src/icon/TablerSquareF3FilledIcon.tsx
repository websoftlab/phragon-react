...
export interface TablerSquareF3FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSquareF3FilledIcon = React.forwardRef<SVGSVGElement, TablerSquareF3FilledIconProps>(
	function TablerSquareF3FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerSquareF3FilledIcon.displayName = "TablerSquareF3FilledIcon";
}
