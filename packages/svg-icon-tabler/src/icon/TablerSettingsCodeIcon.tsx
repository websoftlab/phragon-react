...
export interface TablerSettingsCodeIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSettingsCodeIcon = React.forwardRef<SVGSVGElement, TablerSettingsCodeIconProps>(
	function TablerSettingsCodeIcon(props, ref) {
...
if (__isDev__()) {
	TablerSettingsCodeIcon.displayName = "TablerSettingsCodeIcon";
}
