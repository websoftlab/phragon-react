...
export interface TablerPhoneFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerPhoneFilledIcon = React.forwardRef<SVGSVGElement, TablerPhoneFilledIconProps>(
	function TablerPhoneFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerPhoneFilledIcon.displayName = "TablerPhoneFilledIcon";
}
