...
export interface TablerCloudOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerCloudOffIcon = React.forwardRef<SVGSVGElement, TablerCloudOffIconProps>(function TablerCloudOffIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerCloudOffIcon.displayName = "TablerCloudOffIcon";
}
