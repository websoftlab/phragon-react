...
export interface TablerVolcanoIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerVolcanoIcon = React.forwardRef<SVGSVGElement, TablerVolcanoIconProps>(function TablerVolcanoIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerVolcanoIcon.displayName = "TablerVolcanoIcon";
}
