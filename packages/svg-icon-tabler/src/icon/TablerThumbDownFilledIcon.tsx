...
export interface TablerThumbDownFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerThumbDownFilledIcon = React.forwardRef<SVGSVGElement, TablerThumbDownFilledIconProps>(
	function TablerThumbDownFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerThumbDownFilledIcon.displayName = "TablerThumbDownFilledIcon";
}
