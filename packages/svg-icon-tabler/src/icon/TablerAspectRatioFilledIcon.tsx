...
export interface TablerAspectRatioFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerAspectRatioFilledIcon = React.forwardRef<SVGSVGElement, TablerAspectRatioFilledIconProps>(
	function TablerAspectRatioFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerAspectRatioFilledIcon.displayName = "TablerAspectRatioFilledIcon";
}
