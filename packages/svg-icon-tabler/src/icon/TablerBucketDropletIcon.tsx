...
export interface TablerBucketDropletIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBucketDropletIcon = React.forwardRef<SVGSVGElement, TablerBucketDropletIconProps>(
	function TablerBucketDropletIcon(props, ref) {
...
if (__isDev__()) {
	TablerBucketDropletIcon.displayName = "TablerBucketDropletIcon";
}
