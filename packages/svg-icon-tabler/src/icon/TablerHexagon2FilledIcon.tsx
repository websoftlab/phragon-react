...
export interface TablerHexagon2FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerHexagon2FilledIcon = React.forwardRef<SVGSVGElement, TablerHexagon2FilledIconProps>(
	function TablerHexagon2FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerHexagon2FilledIcon.displayName = "TablerHexagon2FilledIcon";
}
