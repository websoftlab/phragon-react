...
export interface TablerDice2FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerDice2FilledIcon = React.forwardRef<SVGSVGElement, TablerDice2FilledIconProps>(
	function TablerDice2FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerDice2FilledIcon.displayName = "TablerDice2FilledIcon";
}
