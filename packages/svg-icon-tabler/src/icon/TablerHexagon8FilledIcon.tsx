...
export interface TablerHexagon8FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerHexagon8FilledIcon = React.forwardRef<SVGSVGElement, TablerHexagon8FilledIconProps>(
	function TablerHexagon8FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerHexagon8FilledIcon.displayName = "TablerHexagon8FilledIcon";
}
