...
export interface TablerSwipeIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSwipeIcon = React.forwardRef<SVGSVGElement, TablerSwipeIconProps>(function TablerSwipeIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerSwipeIcon.displayName = "TablerSwipeIcon";
}
