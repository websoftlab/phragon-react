...
export interface TablerPawIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerPawIcon = React.forwardRef<SVGSVGElement, TablerPawIconProps>(function TablerPawIcon(props, ref) {
...
if (__isDev__()) {
	TablerPawIcon.displayName = "TablerPawIcon";
}
