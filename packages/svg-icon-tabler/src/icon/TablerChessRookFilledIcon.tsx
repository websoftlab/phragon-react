...
export interface TablerChessRookFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerChessRookFilledIcon = React.forwardRef<SVGSVGElement, TablerChessRookFilledIconProps>(
	function TablerChessRookFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerChessRookFilledIcon.displayName = "TablerChessRookFilledIcon";
}
