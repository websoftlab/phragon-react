...
export interface TablerCircleArrowUpLeftFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerCircleArrowUpLeftFilledIcon = React.forwardRef<
	SVGSVGElement,
	TablerCircleArrowUpLeftFilledIconProps
>(function TablerCircleArrowUpLeftFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerCircleArrowUpLeftFilledIcon.displayName = "TablerCircleArrowUpLeftFilledIcon";
}
