...
export interface TablerCookieOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerCookieOffIcon = React.forwardRef<SVGSVGElement, TablerCookieOffIconProps>(
	function TablerCookieOffIcon(props, ref) {
...
if (__isDev__()) {
	TablerCookieOffIcon.displayName = "TablerCookieOffIcon";
}
