...
export interface TablerHexagon6FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerHexagon6FilledIcon = React.forwardRef<SVGSVGElement, TablerHexagon6FilledIconProps>(
	function TablerHexagon6FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerHexagon6FilledIcon.displayName = "TablerHexagon6FilledIcon";
}
