...
export interface TablerBattery3FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBattery3FilledIcon = React.forwardRef<SVGSVGElement, TablerBattery3FilledIconProps>(
	function TablerBattery3FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerBattery3FilledIcon.displayName = "TablerBattery3FilledIcon";
}
