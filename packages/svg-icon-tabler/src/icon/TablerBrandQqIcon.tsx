...
export interface TablerBrandQqIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandQqIcon = React.forwardRef<SVGSVGElement, TablerBrandQqIconProps>(function TablerBrandQqIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerBrandQqIcon.displayName = "TablerBrandQqIcon";
}
