...
export interface TablerSettingsFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSettingsFilledIcon = React.forwardRef<SVGSVGElement, TablerSettingsFilledIconProps>(
	function TablerSettingsFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerSettingsFilledIcon.displayName = "TablerSettingsFilledIcon";
}
