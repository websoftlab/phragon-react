...
export interface TablerBrandYoutubeKidsIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandYoutubeKidsIcon = React.forwardRef<SVGSVGElement, TablerBrandYoutubeKidsIconProps>(
	function TablerBrandYoutubeKidsIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandYoutubeKidsIcon.displayName = "TablerBrandYoutubeKidsIcon";
}
