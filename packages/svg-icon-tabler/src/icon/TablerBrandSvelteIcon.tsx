...
export interface TablerBrandSvelteIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandSvelteIcon = React.forwardRef<SVGSVGElement, TablerBrandSvelteIconProps>(
	function TablerBrandSvelteIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandSvelteIcon.displayName = "TablerBrandSvelteIcon";
}
