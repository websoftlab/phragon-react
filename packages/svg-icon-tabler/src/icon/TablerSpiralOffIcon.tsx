...
export interface TablerSpiralOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSpiralOffIcon = React.forwardRef<SVGSVGElement, TablerSpiralOffIconProps>(
	function TablerSpiralOffIcon(props, ref) {
...
if (__isDev__()) {
	TablerSpiralOffIcon.displayName = "TablerSpiralOffIcon";
}
