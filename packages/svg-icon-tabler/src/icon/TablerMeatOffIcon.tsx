...
export interface TablerMeatOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerMeatOffIcon = React.forwardRef<SVGSVGElement, TablerMeatOffIconProps>(function TablerMeatOffIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerMeatOffIcon.displayName = "TablerMeatOffIcon";
}
