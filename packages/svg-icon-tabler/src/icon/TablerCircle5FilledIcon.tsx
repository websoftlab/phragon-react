...
export interface TablerCircle5FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerCircle5FilledIcon = React.forwardRef<SVGSVGElement, TablerCircle5FilledIconProps>(
	function TablerCircle5FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerCircle5FilledIcon.displayName = "TablerCircle5FilledIcon";
}
