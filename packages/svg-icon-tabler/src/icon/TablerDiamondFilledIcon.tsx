...
export interface TablerDiamondFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerDiamondFilledIcon = React.forwardRef<SVGSVGElement, TablerDiamondFilledIconProps>(
	function TablerDiamondFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerDiamondFilledIcon.displayName = "TablerDiamondFilledIcon";
}
