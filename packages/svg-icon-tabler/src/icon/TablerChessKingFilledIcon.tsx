...
export interface TablerChessKingFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerChessKingFilledIcon = React.forwardRef<SVGSVGElement, TablerChessKingFilledIconProps>(
	function TablerChessKingFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerChessKingFilledIcon.displayName = "TablerChessKingFilledIcon";
}
