...
export interface TablerBrandDiscordFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandDiscordFilledIcon = React.forwardRef<SVGSVGElement, TablerBrandDiscordFilledIconProps>(
	function TablerBrandDiscordFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandDiscordFilledIcon.displayName = "TablerBrandDiscordFilledIcon";
}
