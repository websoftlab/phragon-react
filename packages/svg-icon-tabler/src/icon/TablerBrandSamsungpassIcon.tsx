...
export interface TablerBrandSamsungpassIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandSamsungpassIcon = React.forwardRef<SVGSVGElement, TablerBrandSamsungpassIconProps>(
	function TablerBrandSamsungpassIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandSamsungpassIcon.displayName = "TablerBrandSamsungpassIcon";
}
