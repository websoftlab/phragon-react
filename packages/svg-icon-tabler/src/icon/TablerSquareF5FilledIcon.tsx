...
export interface TablerSquareF5FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSquareF5FilledIcon = React.forwardRef<SVGSVGElement, TablerSquareF5FilledIconProps>(
	function TablerSquareF5FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerSquareF5FilledIcon.displayName = "TablerSquareF5FilledIcon";
}
