...
export interface TablerThumbUpFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerThumbUpFilledIcon = React.forwardRef<SVGSVGElement, TablerThumbUpFilledIconProps>(
	function TablerThumbUpFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerThumbUpFilledIcon.displayName = "TablerThumbUpFilledIcon";
}
