...
export interface TablerWashTemperature3IconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerWashTemperature3Icon = React.forwardRef<SVGSVGElement, TablerWashTemperature3IconProps>(
	function TablerWashTemperature3Icon(props, ref) {
...
if (__isDev__()) {
	TablerWashTemperature3Icon.displayName = "TablerWashTemperature3Icon";
}
