...
export interface TablerBladeFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBladeFilledIcon = React.forwardRef<SVGSVGElement, TablerBladeFilledIconProps>(
	function TablerBladeFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerBladeFilledIcon.displayName = "TablerBladeFilledIcon";
}
