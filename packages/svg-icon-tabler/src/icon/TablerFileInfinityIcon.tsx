...
export interface TablerFileInfinityIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerFileInfinityIcon = React.forwardRef<SVGSVGElement, TablerFileInfinityIconProps>(
	function TablerFileInfinityIcon(props, ref) {
...
if (__isDev__()) {
	TablerFileInfinityIcon.displayName = "TablerFileInfinityIcon";
}
