...
export interface TablerPolaroidFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerPolaroidFilledIcon = React.forwardRef<SVGSVGElement, TablerPolaroidFilledIconProps>(
	function TablerPolaroidFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerPolaroidFilledIcon.displayName = "TablerPolaroidFilledIcon";
}
