...
export interface TablerStarsFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerStarsFilledIcon = React.forwardRef<SVGSVGElement, TablerStarsFilledIconProps>(
	function TablerStarsFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerStarsFilledIcon.displayName = "TablerStarsFilledIcon";
}
