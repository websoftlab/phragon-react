...
export interface TablerWashIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerWashIcon = React.forwardRef<SVGSVGElement, TablerWashIconProps>(function TablerWashIcon(props, ref) {
...
if (__isDev__()) {
	TablerWashIcon.displayName = "TablerWashIcon";
}
