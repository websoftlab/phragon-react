...
export interface TablerDentalOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerDentalOffIcon = React.forwardRef<SVGSVGElement, TablerDentalOffIconProps>(
	function TablerDentalOffIcon(props, ref) {
...
if (__isDev__()) {
	TablerDentalOffIcon.displayName = "TablerDentalOffIcon";
}
