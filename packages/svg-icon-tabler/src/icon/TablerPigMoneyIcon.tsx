...
export interface TablerPigMoneyIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerPigMoneyIcon = React.forwardRef<SVGSVGElement, TablerPigMoneyIconProps>(function TablerPigMoneyIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerPigMoneyIcon.displayName = "TablerPigMoneyIcon";
}
