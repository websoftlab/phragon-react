...
export interface TablerBrandTaobaoIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandTaobaoIcon = React.forwardRef<SVGSVGElement, TablerBrandTaobaoIconProps>(
	function TablerBrandTaobaoIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandTaobaoIcon.displayName = "TablerBrandTaobaoIcon";
}
