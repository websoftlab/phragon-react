...
export interface TablerBrandSolidjsIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandSolidjsIcon = React.forwardRef<SVGSVGElement, TablerBrandSolidjsIconProps>(
	function TablerBrandSolidjsIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandSolidjsIcon.displayName = "TablerBrandSolidjsIcon";
}
