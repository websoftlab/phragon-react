...
export interface TablerView360OffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerView360OffIcon = React.forwardRef<SVGSVGElement, TablerView360OffIconProps>(
	function TablerView360OffIcon(props, ref) {
...
if (__isDev__()) {
	TablerView360OffIcon.displayName = "TablerView360OffIcon";
}
