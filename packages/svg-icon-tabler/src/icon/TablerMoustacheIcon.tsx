...
export interface TablerMoustacheIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerMoustacheIcon = React.forwardRef<SVGSVGElement, TablerMoustacheIconProps>(
	function TablerMoustacheIcon(props, ref) {
...
if (__isDev__()) {
	TablerMoustacheIcon.displayName = "TablerMoustacheIcon";
}
