...
export interface TablerCardboardsOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerCardboardsOffIcon = React.forwardRef<SVGSVGElement, TablerCardboardsOffIconProps>(
	function TablerCardboardsOffIcon(props, ref) {
...
if (__isDev__()) {
	TablerCardboardsOffIcon.displayName = "TablerCardboardsOffIcon";
}
