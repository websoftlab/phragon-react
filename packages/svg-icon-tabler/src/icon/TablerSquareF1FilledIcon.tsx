...
export interface TablerSquareF1FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSquareF1FilledIcon = React.forwardRef<SVGSVGElement, TablerSquareF1FilledIconProps>(
	function TablerSquareF1FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerSquareF1FilledIcon.displayName = "TablerSquareF1FilledIcon";
}
