...
export interface TablerBrandKickstarterIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandKickstarterIcon = React.forwardRef<SVGSVGElement, TablerBrandKickstarterIconProps>(
	function TablerBrandKickstarterIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandKickstarterIcon.displayName = "TablerBrandKickstarterIcon";
}
