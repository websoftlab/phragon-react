...
export interface TablerTrowelIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerTrowelIcon = React.forwardRef<SVGSVGElement, TablerTrowelIconProps>(function TablerTrowelIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerTrowelIcon.displayName = "TablerTrowelIcon";
}
