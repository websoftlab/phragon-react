...
export interface TablerParachuteOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerParachuteOffIcon = React.forwardRef<SVGSVGElement, TablerParachuteOffIconProps>(
	function TablerParachuteOffIcon(props, ref) {
...
if (__isDev__()) {
	TablerParachuteOffIcon.displayName = "TablerParachuteOffIcon";
}
