...
export interface TablerBrandWechatIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandWechatIcon = React.forwardRef<SVGSVGElement, TablerBrandWechatIconProps>(
	function TablerBrandWechatIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandWechatIcon.displayName = "TablerBrandWechatIcon";
}
