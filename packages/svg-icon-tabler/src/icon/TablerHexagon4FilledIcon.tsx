...
export interface TablerHexagon4FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerHexagon4FilledIcon = React.forwardRef<SVGSVGElement, TablerHexagon4FilledIconProps>(
	function TablerHexagon4FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerHexagon4FilledIcon.displayName = "TablerHexagon4FilledIcon";
}
