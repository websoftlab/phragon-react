...
export interface TablerBucketOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBucketOffIcon = React.forwardRef<SVGSVGElement, TablerBucketOffIconProps>(
	function TablerBucketOffIcon(props, ref) {
...
if (__isDev__()) {
	TablerBucketOffIcon.displayName = "TablerBucketOffIcon";
}
