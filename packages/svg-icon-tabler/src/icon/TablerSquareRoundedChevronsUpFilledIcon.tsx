...
export interface TablerSquareRoundedChevronsUpFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSquareRoundedChevronsUpFilledIcon = React.forwardRef<
	SVGSVGElement,
	TablerSquareRoundedChevronsUpFilledIconProps
>(function TablerSquareRoundedChevronsUpFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerSquareRoundedChevronsUpFilledIcon.displayName = "TablerSquareRoundedChevronsUpFilledIcon";
}
