...
export interface TablerSquareF0FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSquareF0FilledIcon = React.forwardRef<SVGSVGElement, TablerSquareF0FilledIconProps>(
	function TablerSquareF0FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerSquareF0FilledIcon.displayName = "TablerSquareF0FilledIcon";
}
