...
export interface TablerBatIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBatIcon = React.forwardRef<SVGSVGElement, TablerBatIconProps>(function TablerBatIcon(props, ref) {
...
if (__isDev__()) {
	TablerBatIcon.displayName = "TablerBatIcon";
}
