...
export interface TablerPlant2OffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerPlant2OffIcon = React.forwardRef<SVGSVGElement, TablerPlant2OffIconProps>(
	function TablerPlant2OffIcon(props, ref) {
...
if (__isDev__()) {
	TablerPlant2OffIcon.displayName = "TablerPlant2OffIcon";
}
