...
export interface TablerBuildingMosqueIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBuildingMosqueIcon = React.forwardRef<SVGSVGElement, TablerBuildingMosqueIconProps>(
	function TablerBuildingMosqueIcon(props, ref) {
...
if (__isDev__()) {
	TablerBuildingMosqueIcon.displayName = "TablerBuildingMosqueIcon";
}
