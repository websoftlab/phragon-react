...
export interface TablerArrowAutofitContentFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerArrowAutofitContentFilledIcon = React.forwardRef<
	SVGSVGElement,
	TablerArrowAutofitContentFilledIconProps
>(function TablerArrowAutofitContentFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerArrowAutofitContentFilledIcon.displayName = "TablerArrowAutofitContentFilledIcon";
}
