...
export interface TablerDialpadIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerDialpadIcon = React.forwardRef<SVGSVGElement, TablerDialpadIconProps>(function TablerDialpadIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerDialpadIcon.displayName = "TablerDialpadIcon";
}
