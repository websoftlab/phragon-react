...
export interface TablerAppsFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerAppsFilledIcon = React.forwardRef<SVGSVGElement, TablerAppsFilledIconProps>(
	function TablerAppsFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerAppsFilledIcon.displayName = "TablerAppsFilledIcon";
}
