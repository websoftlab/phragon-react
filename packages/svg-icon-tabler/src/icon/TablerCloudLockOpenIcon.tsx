...
export interface TablerCloudLockOpenIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerCloudLockOpenIcon = React.forwardRef<SVGSVGElement, TablerCloudLockOpenIconProps>(
	function TablerCloudLockOpenIcon(props, ref) {
...
if (__isDev__()) {
	TablerCloudLockOpenIcon.displayName = "TablerCloudLockOpenIcon";
}
