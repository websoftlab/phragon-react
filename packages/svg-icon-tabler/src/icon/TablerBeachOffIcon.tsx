...
export interface TablerBeachOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBeachOffIcon = React.forwardRef<SVGSVGElement, TablerBeachOffIconProps>(function TablerBeachOffIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerBeachOffIcon.displayName = "TablerBeachOffIcon";
}
