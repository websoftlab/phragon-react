...
export interface TablerMedicalCrossOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerMedicalCrossOffIcon = React.forwardRef<SVGSVGElement, TablerMedicalCrossOffIconProps>(
	function TablerMedicalCrossOffIcon(props, ref) {
...
if (__isDev__()) {
	TablerMedicalCrossOffIcon.displayName = "TablerMedicalCrossOffIcon";
}
