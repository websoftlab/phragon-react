...
export interface TablerAlarmSnoozeFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerAlarmSnoozeFilledIcon = React.forwardRef<SVGSVGElement, TablerAlarmSnoozeFilledIconProps>(
	function TablerAlarmSnoozeFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerAlarmSnoozeFilledIcon.displayName = "TablerAlarmSnoozeFilledIcon";
}
