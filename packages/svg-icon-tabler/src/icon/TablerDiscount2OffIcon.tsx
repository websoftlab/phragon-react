...
export interface TablerDiscount2OffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerDiscount2OffIcon = React.forwardRef<SVGSVGElement, TablerDiscount2OffIconProps>(
	function TablerDiscount2OffIcon(props, ref) {
...
if (__isDev__()) {
	TablerDiscount2OffIcon.displayName = "TablerDiscount2OffIcon";
}
