...
export interface TablerBrandGithubCopilotIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandGithubCopilotIcon = React.forwardRef<SVGSVGElement, TablerBrandGithubCopilotIconProps>(
	function TablerBrandGithubCopilotIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandGithubCopilotIcon.displayName = "TablerBrandGithubCopilotIcon";
}
