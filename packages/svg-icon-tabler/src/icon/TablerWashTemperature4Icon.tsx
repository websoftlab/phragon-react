...
export interface TablerWashTemperature4IconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerWashTemperature4Icon = React.forwardRef<SVGSVGElement, TablerWashTemperature4IconProps>(
	function TablerWashTemperature4Icon(props, ref) {
...
if (__isDev__()) {
	TablerWashTemperature4Icon.displayName = "TablerWashTemperature4Icon";
}
