...
export interface TablerLungsIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerLungsIcon = React.forwardRef<SVGSVGElement, TablerLungsIconProps>(function TablerLungsIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerLungsIcon.displayName = "TablerLungsIcon";
}
