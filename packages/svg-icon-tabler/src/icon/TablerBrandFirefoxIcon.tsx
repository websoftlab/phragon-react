...
export interface TablerBrandFirefoxIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandFirefoxIcon = React.forwardRef<SVGSVGElement, TablerBrandFirefoxIconProps>(
	function TablerBrandFirefoxIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandFirefoxIcon.displayName = "TablerBrandFirefoxIcon";
}
