...
export interface TablerBrandPaypalFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandPaypalFilledIcon = React.forwardRef<SVGSVGElement, TablerBrandPaypalFilledIconProps>(
	function TablerBrandPaypalFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandPaypalFilledIcon.displayName = "TablerBrandPaypalFilledIcon";
}
