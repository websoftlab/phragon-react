...
export interface TablerSettingsPinIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSettingsPinIcon = React.forwardRef<SVGSVGElement, TablerSettingsPinIconProps>(
	function TablerSettingsPinIcon(props, ref) {
...
if (__isDev__()) {
	TablerSettingsPinIcon.displayName = "TablerSettingsPinIcon";
}
