...
export interface TablerWashPressIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerWashPressIcon = React.forwardRef<SVGSVGElement, TablerWashPressIconProps>(
	function TablerWashPressIcon(props, ref) {
...
if (__isDev__()) {
	TablerWashPressIcon.displayName = "TablerWashPressIcon";
}
