...
export interface TablerBrandStorjIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandStorjIcon = React.forwardRef<SVGSVGElement, TablerBrandStorjIconProps>(
	function TablerBrandStorjIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandStorjIcon.displayName = "TablerBrandStorjIcon";
}
