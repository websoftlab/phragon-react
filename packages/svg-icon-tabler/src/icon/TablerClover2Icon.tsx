...
export interface TablerClover2IconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerClover2Icon = React.forwardRef<SVGSVGElement, TablerClover2IconProps>(function TablerClover2Icon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerClover2Icon.displayName = "TablerClover2Icon";
}
