...
export interface TablerBrandBunpoIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandBunpoIcon = React.forwardRef<SVGSVGElement, TablerBrandBunpoIconProps>(
	function TablerBrandBunpoIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandBunpoIcon.displayName = "TablerBrandBunpoIcon";
}
