...
export interface TablerAlertHexagonFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerAlertHexagonFilledIcon = React.forwardRef<SVGSVGElement, TablerAlertHexagonFilledIconProps>(
	function TablerAlertHexagonFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerAlertHexagonFilledIcon.displayName = "TablerAlertHexagonFilledIcon";
}
