...
export interface TablerWashGentleIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerWashGentleIcon = React.forwardRef<SVGSVGElement, TablerWashGentleIconProps>(
	function TablerWashGentleIcon(props, ref) {
...
if (__isDev__()) {
	TablerWashGentleIcon.displayName = "TablerWashGentleIcon";
}
