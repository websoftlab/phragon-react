...
export interface TablerHexagon3FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerHexagon3FilledIcon = React.forwardRef<SVGSVGElement, TablerHexagon3FilledIconProps>(
	function TablerHexagon3FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerHexagon3FilledIcon.displayName = "TablerHexagon3FilledIcon";
}
