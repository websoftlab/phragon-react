...
export interface TablerPropellerIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerPropellerIcon = React.forwardRef<SVGSVGElement, TablerPropellerIconProps>(
	function TablerPropellerIcon(props, ref) {
...
if (__isDev__()) {
	TablerPropellerIcon.displayName = "TablerPropellerIcon";
}
