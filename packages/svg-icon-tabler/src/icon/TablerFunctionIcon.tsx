...
export interface TablerFunctionIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerFunctionIcon = React.forwardRef<SVGSVGElement, TablerFunctionIconProps>(function TablerFunctionIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerFunctionIcon.displayName = "TablerFunctionIcon";
}
