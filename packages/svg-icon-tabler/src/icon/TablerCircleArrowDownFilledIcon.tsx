...
export interface TablerCircleArrowDownFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerCircleArrowDownFilledIcon = React.forwardRef<SVGSVGElement, TablerCircleArrowDownFilledIconProps>(
	function TablerCircleArrowDownFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerCircleArrowDownFilledIcon.displayName = "TablerCircleArrowDownFilledIcon";
}
