...
export interface TablerHexagon0FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerHexagon0FilledIcon = React.forwardRef<SVGSVGElement, TablerHexagon0FilledIconProps>(
	function TablerHexagon0FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerHexagon0FilledIcon.displayName = "TablerHexagon0FilledIcon";
}
