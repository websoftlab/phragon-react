...
export interface TablerSettingsHeartIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSettingsHeartIcon = React.forwardRef<SVGSVGElement, TablerSettingsHeartIconProps>(
	function TablerSettingsHeartIcon(props, ref) {
...
if (__isDev__()) {
	TablerSettingsHeartIcon.displayName = "TablerSettingsHeartIcon";
}
