...
export interface TablerFlowerOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerFlowerOffIcon = React.forwardRef<SVGSVGElement, TablerFlowerOffIconProps>(
	function TablerFlowerOffIcon(props, ref) {
...
if (__isDev__()) {
	TablerFlowerOffIcon.displayName = "TablerFlowerOffIcon";
}
