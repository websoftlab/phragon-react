...
export interface TablerSquareRoundedChevronsRightFilledIconProps
	extends SVGProps<SVGSVGElement>,
		SvgIconExternalProps {}

export const TablerSquareRoundedChevronsRightFilledIcon = React.forwardRef<
	SVGSVGElement,
	TablerSquareRoundedChevronsRightFilledIconProps
>(function TablerSquareRoundedChevronsRightFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerSquareRoundedChevronsRightFilledIcon.displayName = "TablerSquareRoundedChevronsRightFilledIcon";
}
