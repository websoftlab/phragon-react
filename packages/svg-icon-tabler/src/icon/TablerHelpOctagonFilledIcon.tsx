...
export interface TablerHelpOctagonFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerHelpOctagonFilledIcon = React.forwardRef<SVGSVGElement, TablerHelpOctagonFilledIconProps>(
	function TablerHelpOctagonFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerHelpOctagonFilledIcon.displayName = "TablerHelpOctagonFilledIcon";
}
