...
export interface TablerBrandVivaldiIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandVivaldiIcon = React.forwardRef<SVGSVGElement, TablerBrandVivaldiIconProps>(
	function TablerBrandVivaldiIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandVivaldiIcon.displayName = "TablerBrandVivaldiIcon";
}
