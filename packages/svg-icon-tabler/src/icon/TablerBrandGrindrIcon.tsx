...
export interface TablerBrandGrindrIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandGrindrIcon = React.forwardRef<SVGSVGElement, TablerBrandGrindrIconProps>(
	function TablerBrandGrindrIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandGrindrIcon.displayName = "TablerBrandGrindrIcon";
}
