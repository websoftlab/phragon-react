...
export interface TablerSquareF6FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSquareF6FilledIcon = React.forwardRef<SVGSVGElement, TablerSquareF6FilledIconProps>(
	function TablerSquareF6FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerSquareF6FilledIcon.displayName = "TablerSquareF6FilledIcon";
}
