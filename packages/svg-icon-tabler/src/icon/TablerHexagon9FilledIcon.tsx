...
export interface TablerHexagon9FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerHexagon9FilledIcon = React.forwardRef<SVGSVGElement, TablerHexagon9FilledIconProps>(
	function TablerHexagon9FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerHexagon9FilledIcon.displayName = "TablerHexagon9FilledIcon";
}
