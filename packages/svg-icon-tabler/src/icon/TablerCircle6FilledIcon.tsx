...
export interface TablerCircle6FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerCircle6FilledIcon = React.forwardRef<SVGSVGElement, TablerCircle6FilledIconProps>(
	function TablerCircle6FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerCircle6FilledIcon.displayName = "TablerCircle6FilledIcon";
}
