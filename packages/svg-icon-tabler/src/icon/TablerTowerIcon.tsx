...
export interface TablerTowerIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerTowerIcon = React.forwardRef<SVGSVGElement, TablerTowerIconProps>(function TablerTowerIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerTowerIcon.displayName = "TablerTowerIcon";
}
