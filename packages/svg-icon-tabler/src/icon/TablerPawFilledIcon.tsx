...
export interface TablerPawFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerPawFilledIcon = React.forwardRef<SVGSVGElement, TablerPawFilledIconProps>(
	function TablerPawFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerPawFilledIcon.displayName = "TablerPawFilledIcon";
}
