...
export interface TablerBottleIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBottleIcon = React.forwardRef<SVGSVGElement, TablerBottleIconProps>(function TablerBottleIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerBottleIcon.displayName = "TablerBottleIcon";
}
