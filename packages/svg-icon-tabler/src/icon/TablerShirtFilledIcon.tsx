...
export interface TablerShirtFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerShirtFilledIcon = React.forwardRef<SVGSVGElement, TablerShirtFilledIconProps>(
	function TablerShirtFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerShirtFilledIcon.displayName = "TablerShirtFilledIcon";
}
