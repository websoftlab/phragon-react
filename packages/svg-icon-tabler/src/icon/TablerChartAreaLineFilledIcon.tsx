...
export interface TablerChartAreaLineFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerChartAreaLineFilledIcon = React.forwardRef<SVGSVGElement, TablerChartAreaLineFilledIconProps>(
	function TablerChartAreaLineFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerChartAreaLineFilledIcon.displayName = "TablerChartAreaLineFilledIcon";
}
