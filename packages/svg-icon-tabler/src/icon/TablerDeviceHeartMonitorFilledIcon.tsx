...
export interface TablerDeviceHeartMonitorFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerDeviceHeartMonitorFilledIcon = React.forwardRef<
	SVGSVGElement,
	TablerDeviceHeartMonitorFilledIconProps
>(function TablerDeviceHeartMonitorFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerDeviceHeartMonitorFilledIcon.displayName = "TablerDeviceHeartMonitorFilledIcon";
}
