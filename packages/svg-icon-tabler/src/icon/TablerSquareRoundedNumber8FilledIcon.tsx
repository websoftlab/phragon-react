...
export interface TablerSquareRoundedNumber8FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSquareRoundedNumber8FilledIcon = React.forwardRef<
	SVGSVGElement,
	TablerSquareRoundedNumber8FilledIconProps
>(function TablerSquareRoundedNumber8FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerSquareRoundedNumber8FilledIcon.displayName = "TablerSquareRoundedNumber8FilledIcon";
}
