...
export interface TablerRadioactiveFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerRadioactiveFilledIcon = React.forwardRef<SVGSVGElement, TablerRadioactiveFilledIconProps>(
	function TablerRadioactiveFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerRadioactiveFilledIcon.displayName = "TablerRadioactiveFilledIcon";
}
