...
export interface TablerBrandSassIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandSassIcon = React.forwardRef<SVGSVGElement, TablerBrandSassIconProps>(
	function TablerBrandSassIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandSassIcon.displayName = "TablerBrandSassIcon";
}
