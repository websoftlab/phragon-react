...
export interface TablerSpiralIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSpiralIcon = React.forwardRef<SVGSVGElement, TablerSpiralIconProps>(function TablerSpiralIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerSpiralIcon.displayName = "TablerSpiralIcon";
}
