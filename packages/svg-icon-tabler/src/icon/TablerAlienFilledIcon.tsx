...
export interface TablerAlienFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerAlienFilledIcon = React.forwardRef<SVGSVGElement, TablerAlienFilledIconProps>(
	function TablerAlienFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerAlienFilledIcon.displayName = "TablerAlienFilledIcon";
}
