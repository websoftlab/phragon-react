...
export interface TablerCircle3FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerCircle3FilledIcon = React.forwardRef<SVGSVGElement, TablerCircle3FilledIconProps>(
	function TablerCircle3FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerCircle3FilledIcon.displayName = "TablerCircle3FilledIcon";
}
