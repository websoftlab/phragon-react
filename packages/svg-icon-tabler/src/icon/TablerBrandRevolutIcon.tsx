...
export interface TablerBrandRevolutIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandRevolutIcon = React.forwardRef<SVGSVGElement, TablerBrandRevolutIconProps>(
	function TablerBrandRevolutIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandRevolutIcon.displayName = "TablerBrandRevolutIcon";
}
