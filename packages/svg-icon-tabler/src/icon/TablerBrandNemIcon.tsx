...
export interface TablerBrandNemIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandNemIcon = React.forwardRef<SVGSVGElement, TablerBrandNemIconProps>(function TablerBrandNemIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerBrandNemIcon.displayName = "TablerBrandNemIcon";
}
