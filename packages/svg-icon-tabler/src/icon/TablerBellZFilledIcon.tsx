...
export interface TablerBellZFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBellZFilledIcon = React.forwardRef<SVGSVGElement, TablerBellZFilledIconProps>(
	function TablerBellZFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerBellZFilledIcon.displayName = "TablerBellZFilledIcon";
}
