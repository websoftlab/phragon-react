...
export interface TablerSquareRoundedArrowUpFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSquareRoundedArrowUpFilledIcon = React.forwardRef<
	SVGSVGElement,
	TablerSquareRoundedArrowUpFilledIconProps
>(function TablerSquareRoundedArrowUpFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerSquareRoundedArrowUpFilledIcon.displayName = "TablerSquareRoundedArrowUpFilledIcon";
}
