...
export interface TablerInfoHexagonFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerInfoHexagonFilledIcon = React.forwardRef<SVGSVGElement, TablerInfoHexagonFilledIconProps>(
	function TablerInfoHexagonFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerInfoHexagonFilledIcon.displayName = "TablerInfoHexagonFilledIcon";
}
