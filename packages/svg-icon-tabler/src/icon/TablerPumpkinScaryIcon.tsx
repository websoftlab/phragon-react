...
export interface TablerPumpkinScaryIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerPumpkinScaryIcon = React.forwardRef<SVGSVGElement, TablerPumpkinScaryIconProps>(
	function TablerPumpkinScaryIcon(props, ref) {
...
if (__isDev__()) {
	TablerPumpkinScaryIcon.displayName = "TablerPumpkinScaryIcon";
}
