...
export interface TablerPropellerOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerPropellerOffIcon = React.forwardRef<SVGSVGElement, TablerPropellerOffIconProps>(
	function TablerPropellerOffIcon(props, ref) {
...
if (__isDev__()) {
	TablerPropellerOffIcon.displayName = "TablerPropellerOffIcon";
}
