...
export interface TablerMoodEmptyFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerMoodEmptyFilledIcon = React.forwardRef<SVGSVGElement, TablerMoodEmptyFilledIconProps>(
	function TablerMoodEmptyFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerMoodEmptyFilledIcon.displayName = "TablerMoodEmptyFilledIcon";
}
