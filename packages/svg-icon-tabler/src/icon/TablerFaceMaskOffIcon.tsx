...
export interface TablerFaceMaskOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerFaceMaskOffIcon = React.forwardRef<SVGSVGElement, TablerFaceMaskOffIconProps>(
	function TablerFaceMaskOffIcon(props, ref) {
...
if (__isDev__()) {
	TablerFaceMaskOffIcon.displayName = "TablerFaceMaskOffIcon";
}
