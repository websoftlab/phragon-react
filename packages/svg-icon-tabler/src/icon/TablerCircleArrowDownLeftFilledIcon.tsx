...
export interface TablerCircleArrowDownLeftFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerCircleArrowDownLeftFilledIcon = React.forwardRef<
	SVGSVGElement,
	TablerCircleArrowDownLeftFilledIconProps
>(function TablerCircleArrowDownLeftFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerCircleArrowDownLeftFilledIcon.displayName = "TablerCircleArrowDownLeftFilledIcon";
}
