...
export interface TablerAdFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerAdFilledIcon = React.forwardRef<SVGSVGElement, TablerAdFilledIconProps>(function TablerAdFilledIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerAdFilledIcon.displayName = "TablerAdFilledIcon";
}
