...
export interface TablerVectorOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerVectorOffIcon = React.forwardRef<SVGSVGElement, TablerVectorOffIconProps>(
	function TablerVectorOffIcon(props, ref) {
...
if (__isDev__()) {
	TablerVectorOffIcon.displayName = "TablerVectorOffIcon";
}
