...
export interface TablerSquareF8FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSquareF8FilledIcon = React.forwardRef<SVGSVGElement, TablerSquareF8FilledIconProps>(
	function TablerSquareF8FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerSquareF8FilledIcon.displayName = "TablerSquareF8FilledIcon";
}
