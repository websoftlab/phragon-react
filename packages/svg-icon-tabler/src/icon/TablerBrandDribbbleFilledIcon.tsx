...
export interface TablerBrandDribbbleFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandDribbbleFilledIcon = React.forwardRef<SVGSVGElement, TablerBrandDribbbleFilledIconProps>(
	function TablerBrandDribbbleFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandDribbbleFilledIcon.displayName = "TablerBrandDribbbleFilledIcon";
}
