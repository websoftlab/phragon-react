...
export interface TablerAssemblyOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerAssemblyOffIcon = React.forwardRef<SVGSVGElement, TablerAssemblyOffIconProps>(
	function TablerAssemblyOffIcon(props, ref) {
...
if (__isDev__()) {
	TablerAssemblyOffIcon.displayName = "TablerAssemblyOffIcon";
}
