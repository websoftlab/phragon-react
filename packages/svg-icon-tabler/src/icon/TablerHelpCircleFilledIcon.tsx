...
export interface TablerHelpCircleFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerHelpCircleFilledIcon = React.forwardRef<SVGSVGElement, TablerHelpCircleFilledIconProps>(
	function TablerHelpCircleFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerHelpCircleFilledIcon.displayName = "TablerHelpCircleFilledIcon";
}
