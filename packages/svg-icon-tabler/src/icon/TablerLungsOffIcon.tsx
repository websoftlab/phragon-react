...
export interface TablerLungsOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerLungsOffIcon = React.forwardRef<SVGSVGElement, TablerLungsOffIconProps>(function TablerLungsOffIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerLungsOffIcon.displayName = "TablerLungsOffIcon";
}
