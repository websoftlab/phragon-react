...
export interface TablerAwardFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerAwardFilledIcon = React.forwardRef<SVGSVGElement, TablerAwardFilledIconProps>(
	function TablerAwardFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerAwardFilledIcon.displayName = "TablerAwardFilledIcon";
}
