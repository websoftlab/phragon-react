...
export interface TablerAnalyzeOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerAnalyzeOffIcon = React.forwardRef<SVGSVGElement, TablerAnalyzeOffIconProps>(
	function TablerAnalyzeOffIcon(props, ref) {
...
if (__isDev__()) {
	TablerAnalyzeOffIcon.displayName = "TablerAnalyzeOffIcon";
}
