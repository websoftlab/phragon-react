...
export interface TablerBrandCohostIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandCohostIcon = React.forwardRef<SVGSVGElement, TablerBrandCohostIconProps>(
	function TablerBrandCohostIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandCohostIcon.displayName = "TablerBrandCohostIcon";
}
