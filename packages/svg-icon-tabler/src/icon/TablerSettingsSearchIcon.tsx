...
export interface TablerSettingsSearchIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSettingsSearchIcon = React.forwardRef<SVGSVGElement, TablerSettingsSearchIconProps>(
	function TablerSettingsSearchIcon(props, ref) {
...
if (__isDev__()) {
	TablerSettingsSearchIcon.displayName = "TablerSettingsSearchIcon";
}
