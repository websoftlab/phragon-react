...
export interface TablerBaguetteIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBaguetteIcon = React.forwardRef<SVGSVGElement, TablerBaguetteIconProps>(function TablerBaguetteIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerBaguetteIcon.displayName = "TablerBaguetteIcon";
}
