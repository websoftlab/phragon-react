...
export interface TablerVectorBezierArcIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerVectorBezierArcIcon = React.forwardRef<SVGSVGElement, TablerVectorBezierArcIconProps>(
	function TablerVectorBezierArcIcon(props, ref) {
...
if (__isDev__()) {
	TablerVectorBezierArcIcon.displayName = "TablerVectorBezierArcIcon";
}
