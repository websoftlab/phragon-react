...
export interface TablerSettingsStarIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSettingsStarIcon = React.forwardRef<SVGSVGElement, TablerSettingsStarIconProps>(
	function TablerSettingsStarIcon(props, ref) {
...
if (__isDev__()) {
	TablerSettingsStarIcon.displayName = "TablerSettingsStarIcon";
}
