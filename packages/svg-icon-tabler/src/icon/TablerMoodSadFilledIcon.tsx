...
export interface TablerMoodSadFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerMoodSadFilledIcon = React.forwardRef<SVGSVGElement, TablerMoodSadFilledIconProps>(
	function TablerMoodSadFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerMoodSadFilledIcon.displayName = "TablerMoodSadFilledIcon";
}
