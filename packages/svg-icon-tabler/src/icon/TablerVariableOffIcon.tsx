...
export interface TablerVariableOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerVariableOffIcon = React.forwardRef<SVGSVGElement, TablerVariableOffIconProps>(
	function TablerVariableOffIcon(props, ref) {
...
if (__isDev__()) {
	TablerVariableOffIcon.displayName = "TablerVariableOffIcon";
}
