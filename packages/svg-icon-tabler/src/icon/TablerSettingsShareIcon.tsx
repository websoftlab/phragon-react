...
export interface TablerSettingsShareIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSettingsShareIcon = React.forwardRef<SVGSVGElement, TablerSettingsShareIconProps>(
	function TablerSettingsShareIcon(props, ref) {
...
if (__isDev__()) {
	TablerSettingsShareIcon.displayName = "TablerSettingsShareIcon";
}
