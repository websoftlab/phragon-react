...
export interface TablerInfoCircleFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerInfoCircleFilledIcon = React.forwardRef<SVGSVGElement, TablerInfoCircleFilledIconProps>(
	function TablerInfoCircleFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerInfoCircleFilledIcon.displayName = "TablerInfoCircleFilledIcon";
}
