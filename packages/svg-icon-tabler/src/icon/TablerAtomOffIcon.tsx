...
export interface TablerAtomOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerAtomOffIcon = React.forwardRef<SVGSVGElement, TablerAtomOffIconProps>(function TablerAtomOffIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerAtomOffIcon.displayName = "TablerAtomOffIcon";
}
