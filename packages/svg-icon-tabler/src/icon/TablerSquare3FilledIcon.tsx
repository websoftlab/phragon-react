...
export interface TablerSquare3FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSquare3FilledIcon = React.forwardRef<SVGSVGElement, TablerSquare3FilledIconProps>(
	function TablerSquare3FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerSquare3FilledIcon.displayName = "TablerSquare3FilledIcon";
}
