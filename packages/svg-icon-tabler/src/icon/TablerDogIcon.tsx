...
export interface TablerDogIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerDogIcon = React.forwardRef<SVGSVGElement, TablerDogIconProps>(function TablerDogIcon(props, ref) {
...
if (__isDev__()) {
	TablerDogIcon.displayName = "TablerDogIcon";
}
