...
export interface TablerUfoOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerUfoOffIcon = React.forwardRef<SVGSVGElement, TablerUfoOffIconProps>(function TablerUfoOffIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerUfoOffIcon.displayName = "TablerUfoOffIcon";
}
