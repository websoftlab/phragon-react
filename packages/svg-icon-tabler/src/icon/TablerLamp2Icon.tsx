...
export interface TablerLamp2IconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerLamp2Icon = React.forwardRef<SVGSVGElement, TablerLamp2IconProps>(function TablerLamp2Icon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerLamp2Icon.displayName = "TablerLamp2Icon";
}
