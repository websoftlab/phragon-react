...
export interface TablerBrandZalandoIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandZalandoIcon = React.forwardRef<SVGSVGElement, TablerBrandZalandoIconProps>(
	function TablerBrandZalandoIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandZalandoIcon.displayName = "TablerBrandZalandoIcon";
}
