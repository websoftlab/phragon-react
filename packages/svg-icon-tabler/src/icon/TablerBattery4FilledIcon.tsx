...
export interface TablerBattery4FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBattery4FilledIcon = React.forwardRef<SVGSVGElement, TablerBattery4FilledIconProps>(
	function TablerBattery4FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerBattery4FilledIcon.displayName = "TablerBattery4FilledIcon";
}
