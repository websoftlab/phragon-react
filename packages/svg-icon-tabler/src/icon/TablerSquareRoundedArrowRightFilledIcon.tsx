...
export interface TablerSquareRoundedArrowRightFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSquareRoundedArrowRightFilledIcon = React.forwardRef<
	SVGSVGElement,
	TablerSquareRoundedArrowRightFilledIconProps
>(function TablerSquareRoundedArrowRightFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerSquareRoundedArrowRightFilledIcon.displayName = "TablerSquareRoundedArrowRightFilledIcon";
}
