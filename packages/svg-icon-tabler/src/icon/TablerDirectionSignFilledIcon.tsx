...
export interface TablerDirectionSignFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerDirectionSignFilledIcon = React.forwardRef<SVGSVGElement, TablerDirectionSignFilledIconProps>(
	function TablerDirectionSignFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerDirectionSignFilledIcon.displayName = "TablerDirectionSignFilledIcon";
}
