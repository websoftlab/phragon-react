...
export interface TablerSquareF2FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSquareF2FilledIcon = React.forwardRef<SVGSVGElement, TablerSquareF2FilledIconProps>(
	function TablerSquareF2FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerSquareF2FilledIcon.displayName = "TablerSquareF2FilledIcon";
}
