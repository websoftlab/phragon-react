...
export interface TablerCloudFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerCloudFilledIcon = React.forwardRef<SVGSVGElement, TablerCloudFilledIconProps>(
	function TablerCloudFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerCloudFilledIcon.displayName = "TablerCloudFilledIcon";
}
