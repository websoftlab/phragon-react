...
export interface TablerBrandBloggerIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandBloggerIcon = React.forwardRef<SVGSVGElement, TablerBrandBloggerIconProps>(
	function TablerBrandBloggerIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandBloggerIcon.displayName = "TablerBrandBloggerIcon";
}
