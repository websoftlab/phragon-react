...
export interface TablerInfoOctagonFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerInfoOctagonFilledIcon = React.forwardRef<SVGSVGElement, TablerInfoOctagonFilledIconProps>(
	function TablerInfoOctagonFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerInfoOctagonFilledIcon.displayName = "TablerInfoOctagonFilledIcon";
}
