...
export interface TablerCherryFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerCherryFilledIcon = React.forwardRef<SVGSVGElement, TablerCherryFilledIconProps>(
	function TablerCherryFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerCherryFilledIcon.displayName = "TablerCherryFilledIcon";
}
