...
export interface TablerHelpHexagonFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerHelpHexagonFilledIcon = React.forwardRef<SVGSVGElement, TablerHelpHexagonFilledIconProps>(
	function TablerHelpHexagonFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerHelpHexagonFilledIcon.displayName = "TablerHelpHexagonFilledIcon";
}
