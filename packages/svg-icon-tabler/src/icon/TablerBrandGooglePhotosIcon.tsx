...
export interface TablerBrandGooglePhotosIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrandGooglePhotosIcon = React.forwardRef<SVGSVGElement, TablerBrandGooglePhotosIconProps>(
	function TablerBrandGooglePhotosIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrandGooglePhotosIcon.displayName = "TablerBrandGooglePhotosIcon";
}
