...
export interface TablerArrowBigLeftLineFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerArrowBigLeftLineFilledIcon = React.forwardRef<SVGSVGElement, TablerArrowBigLeftLineFilledIconProps>(
	function TablerArrowBigLeftLineFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerArrowBigLeftLineFilledIcon.displayName = "TablerArrowBigLeftLineFilledIcon";
}
