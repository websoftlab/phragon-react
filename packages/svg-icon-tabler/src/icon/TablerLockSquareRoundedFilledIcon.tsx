...
export interface TablerLockSquareRoundedFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerLockSquareRoundedFilledIcon = React.forwardRef<
	SVGSVGElement,
	TablerLockSquareRoundedFilledIconProps
>(function TablerLockSquareRoundedFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerLockSquareRoundedFilledIcon.displayName = "TablerLockSquareRoundedFilledIcon";
}
