...
export interface TablerTowerOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerTowerOffIcon = React.forwardRef<SVGSVGElement, TablerTowerOffIconProps>(function TablerTowerOffIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerTowerOffIcon.displayName = "TablerTowerOffIcon";
}
