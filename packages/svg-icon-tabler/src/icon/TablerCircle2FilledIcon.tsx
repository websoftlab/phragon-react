...
export interface TablerCircle2FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerCircle2FilledIcon = React.forwardRef<SVGSVGElement, TablerCircle2FilledIconProps>(
	function TablerCircle2FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerCircle2FilledIcon.displayName = "TablerCircle2FilledIcon";
}
