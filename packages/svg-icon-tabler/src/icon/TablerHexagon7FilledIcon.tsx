...
export interface TablerHexagon7FilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerHexagon7FilledIcon = React.forwardRef<SVGSVGElement, TablerHexagon7FilledIconProps>(
	function TablerHexagon7FilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerHexagon7FilledIcon.displayName = "TablerHexagon7FilledIcon";
}
