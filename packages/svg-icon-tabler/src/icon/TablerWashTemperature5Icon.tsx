...
export interface TablerWashTemperature5IconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerWashTemperature5Icon = React.forwardRef<SVGSVGElement, TablerWashTemperature5IconProps>(
	function TablerWashTemperature5Icon(props, ref) {
...
if (__isDev__()) {
	TablerWashTemperature5Icon.displayName = "TablerWashTemperature5Icon";
}
