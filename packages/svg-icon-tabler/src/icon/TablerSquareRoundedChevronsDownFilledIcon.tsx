...
export interface TablerSquareRoundedChevronsDownFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerSquareRoundedChevronsDownFilledIcon = React.forwardRef<
	SVGSVGElement,
	TablerSquareRoundedChevronsDownFilledIconProps
>(function TablerSquareRoundedChevronsDownFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerSquareRoundedChevronsDownFilledIcon.displayName = "TablerSquareRoundedChevronsDownFilledIcon";
}
