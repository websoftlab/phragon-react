...
export interface TablerBrand4chanIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerBrand4chanIcon = React.forwardRef<SVGSVGElement, TablerBrand4chanIconProps>(
	function TablerBrand4chanIcon(props, ref) {
...
if (__isDev__()) {
	TablerBrand4chanIcon.displayName = "TablerBrand4chanIcon";
}
