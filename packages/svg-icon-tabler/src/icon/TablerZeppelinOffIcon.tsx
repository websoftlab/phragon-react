...
export interface TablerZeppelinOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerZeppelinOffIcon = React.forwardRef<SVGSVGElement, TablerZeppelinOffIconProps>(
	function TablerZeppelinOffIcon(props, ref) {
...
if (__isDev__()) {
	TablerZeppelinOffIcon.displayName = "TablerZeppelinOffIcon";
}
