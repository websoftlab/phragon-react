...
export interface TablerCloudLockIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerCloudLockIcon = React.forwardRef<SVGSVGElement, TablerCloudLockIconProps>(
	function TablerCloudLockIcon(props, ref) {
...
if (__isDev__()) {
	TablerCloudLockIcon.displayName = "TablerCloudLockIcon";
}
