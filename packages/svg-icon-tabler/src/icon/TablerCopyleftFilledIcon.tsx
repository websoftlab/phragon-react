...
export interface TablerCopyleftFilledIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerCopyleftFilledIcon = React.forwardRef<SVGSVGElement, TablerCopyleftFilledIconProps>(
	function TablerCopyleftFilledIcon(props, ref) {
...
if (__isDev__()) {
	TablerCopyleftFilledIcon.displayName = "TablerCopyleftFilledIcon";
}
