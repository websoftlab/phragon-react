...
export interface TablerCloverIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerCloverIcon = React.forwardRef<SVGSVGElement, TablerCloverIconProps>(function TablerCloverIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerCloverIcon.displayName = "TablerCloverIcon";
}
