...
export interface TablerHopIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerHopIcon = React.forwardRef<SVGSVGElement, TablerHopIconProps>(function TablerHopIcon(props, ref) {
...
if (__isDev__()) {
	TablerHopIcon.displayName = "TablerHopIcon";
}
