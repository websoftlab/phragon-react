...
export interface TablerCroissantIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerCroissantIcon = React.forwardRef<SVGSVGElement, TablerCroissantIconProps>(
	function TablerCroissantIcon(props, ref) {
...
if (__isDev__()) {
	TablerCroissantIcon.displayName = "TablerCroissantIcon";
}
