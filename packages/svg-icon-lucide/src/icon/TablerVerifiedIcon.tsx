...
export interface TablerVerifiedIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerVerifiedIcon = React.forwardRef<SVGSVGElement, TablerVerifiedIconProps>(function TablerVerifiedIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerVerifiedIcon.displayName = "TablerVerifiedIcon";
}
