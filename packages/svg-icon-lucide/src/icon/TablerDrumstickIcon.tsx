...
export interface TablerDrumstickIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerDrumstickIcon = React.forwardRef<SVGSVGElement, TablerDrumstickIconProps>(
	function TablerDrumstickIcon(props, ref) {
...
if (__isDev__()) {
	TablerDrumstickIcon.displayName = "TablerDrumstickIcon";
}
