...
export interface TablerNutOffIconProps extends SVGProps<SVGSVGElement>, SvgIconExternalProps {}

export const TablerNutOffIcon = React.forwardRef<SVGSVGElement, TablerNutOffIconProps>(function TablerNutOffIcon(
	props,
	ref
) {
...
if (__isDev__()) {
	TablerNutOffIcon.displayName = "TablerNutOffIcon";
}
